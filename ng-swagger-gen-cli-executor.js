...
var presentCompareResult = function (apis, checkedApis) {
...
var compare = function (apis) {
    ...
    tasks.run().then(function () { return presentCompareResult(apis, checkedApis); }, function () { return presentCompareResult(apis, checkedApis); });
};
